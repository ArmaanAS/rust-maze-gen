...
impl Display for Maze {
    ...
    //     }
    //     write!(f, "\n  {}\n", "██".repeat((self.w + 2) as usize))?;
    //     // char index = 0 0 0 0 -> left right up down
    //     // 0000
    //     // 0001 - down
    //     // 0010 - up
    //     // 0011 - up down
    ...
    //     let wall_index = |x: u32, y: u32| (y * self.w + x) as usize;

    //     let wall_char = |x: u32, y: u32| {
    //         if !self.walls[wall_index(x, y)] {
    //             return ' ';
    //         }
    ...
    //         // Left
    //         if x == 0 || x > 0 && self.walls[wall_index(x - 1, y)] {
    //             wall |= 0b1000;
    //         }

    //         // Up
    //         if y == 0 || y > 0 && self.walls[wall_index(x, y - 1)] {
    //             wall |= 0b0010;
    //         }

    //         // Right
    //         if x == self.w - 1 || x < self.w - 1 && self.walls[wall_index(x + 1, y)] {
    //             wall |= 0b0100;
    //         }

    //         // Down
    //         if y == self.h - 1 || y < self.h - 1 && self.walls[wall_index(x, y + 1)] {
    //             wall |= 0b0001;
    //         }
    ...
    //     write!(f, "\n  {}", "█".repeat((self.w + 4) as usize))?;
    //     for y in 0..self.h {
    //         write!(f, "\n  ██")?;
    //         for x in 0..self.w {
    //             write!(f, "{}", wall_char(x, y))?;
    //         }
    //         write!(f, "██")?;
    //     }
    //     write!(f, "\n  {}\n", "█".repeat((self.w + 4) as usize))?;
